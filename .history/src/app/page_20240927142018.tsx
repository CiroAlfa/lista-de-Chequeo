...
export default function Home() {
        ...
        <table className="w-full border-collapse">
          ...
          <tbody>
            {checklist.map((item, index) => (
              <tr key={item.id} className={index % 2 === 0 ? 'bg-blue-800' : 'bg-blue-100'}>
  ...
  <div className="overflow-x-auto">
    <table className="w-full border-collapse table-fixed">
      <thead>
        <tr className="bg-blue-600 text-white">
          <th className="border p-2 text-xs" style={{width: '7%'}}>ID Req.</th>
          <th className="border p-2 text-xs" style={{width: '13%'}}>Descripción</th>
          <th className="border p-2 text-xs" style={{width: '8%'}}>Prioridad</th>
          <th className="border p-2 text-xs" style={{width: '8%'}}>Estado</th>
          <th className="border p-2 text-xs" style={{width: '10%'}}>Última actualización</th>
          <th className="border p-2 text-xs" style={{width: '13%'}}>Criterios de aceptación</th>
          <th className="border p-2 text-xs" style={{width: '8%'}}>Complejidad</th>
          <th className="border p-2 text-xs" style={{width: '11%'}}>Entregables</th>
          <th className="border p-2 text-xs" style={{width: '11%'}}>Escenarios de pruebas</th>
          <th className="border p-2 text-xs" style={{width: '11%'}}>Interesado</th>
        </tr>
      </thead>
      <tbody>
        {requirements.map((item, index) => (
          <tr key={index} className={index % 2 === 0 ? 'bg-blue-800' : 'bg-blue-500'}>
