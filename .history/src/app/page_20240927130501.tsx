    ...
    <main className="container mx-auto p-4">
      <div className="mb-8" id="checklist-table">
        ...
        <table className="w-full border-collapse">
          <thead>
            <tr className="bg-blue-600 text-red">
            ...
            {checklist.map((item, index) => (
              <tr key={item.id} className={index % 2 === 0 ? 'bg-blue-100' : 'bg-blue-50'}>
                ...
                <td className="border p-2">
                  ...
                  >
                    <span className={`${item.cumple ? 'translate-x-6' : 'translate-x-1'} inline-block h-4 w-4 transform rounded-full bg-red`} />
                  </Switch>
                </td>
                <td className="border p-2">
                  <Switch
                  ...
                  >
                    <span className={`${item.noCumple ? 'translate-x-6' : 'translate-x-1'} inline-block h-4 w-4 transform rounded-full bg-red transition`} />
                  </Switch>
                </td>
                <td className="border p-2">
                  <Switch
                  ...
                  >
                    <span className={`${item.noAplica ? 'translate-x-6' : 'translate-x-1'} inline-block h-4 w-4 transform rounded-full bg-black transition`} />
                  </Switch>
                </td>
              </tr>
            ))}
      ...
      <div className="mb-8" id="requirements-table">
        ...
        <div className="mt-4 flex justify-between">
          <button
            ...
            className="bg-green-500 text-zinc-950 px-4 py-2 rounded hover:bg-green-600 transition-colors"
          >
            Agregar Requerimiento
          </button>
          <button
            onClick={() => captureScreenshot('requirements-table', 'plantilla-trazabilidad-requisitos.png')}
            className="bg-blue-500 text-neutral-900 px-4 py-2 rounded hover:bg-blue-600 transition-colors"
          >
